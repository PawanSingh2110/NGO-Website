...
const AnimalWelfarePage = () => {
  const teamMembers = [
    ...
    { name: 'Suman Nazareth', image: 'https://images.unsplash.com/flagged/photo-1570612861542-284f4c12e75f?w=600&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MTB8fHBlcnNvbnxlbnwwfHwwfHx8MA%3D%3D' },
    { name: 'Rhea Malhtani', image: 'https://images.unsplash.com/photo-1499952127939-9bbf5af6c51c?w=600&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MTV8fHBlcnNvbnxlbnwwfHwwfHx8MA%3D%3D' },
    ...
    { name: 'Mufaddal Cementwala', image: 'https://images.unsplash.com/photo-1547425260-76bcadfb4f2c?w=600&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MTZ8fHBlcnNvbnxlbnwwfHwwfHx8MA%3D%3D' },
    { name: 'Sushma Jayachandran', image: 'https://media.istockphoto.com/id/941782244/photo/portrait-of-a-young-school-boy-smiling.webp?a=1&b=1&s=612x612&w=0&k=20&c=p_rMVJrgBj8-ZdVP-k8C-Lb0stZZ5JRZF_wpAnd9o3s=' },
